...
# ExpliTest XAI metrics
from ExpliTest.metrics.feature_attribution.timeseries_multivariate.faithfulness.faithfulness_correlation import FAMVFaithfulnessCorrelation
from ExpliTest.metrics.feature_attribution.timeseries_multivariate.faithfulness.pixel_flipping import FAMVPixelFlipping
from ExpliTest.metrics.feature_attribution.timeseries_multivariate.robustness.avg_sensitivity import FAMVAvgSensitivity
from ExpliTest.metrics.feature_attribution.timeseries_multivariate.robustness.continuity import FAMVContinuity
from ExpliTest.metrics.feature_attribution.timeseries_multivariate.complexity.sparseness import FAMVSparsenessElement, FAMVSparsenessChannel
from ExpliTest.metrics.feature_attribution.timeseries_multivariate.complexity.complexity_entropy import FAMVComplexityEntropyElement, FAMVComplexityEntropyChannel
...
logger = logging.getLogger("xrul.xai_eval")
...
def _build_xai_metrics(kind: str) -> Dict[str, Any]:
    """
    Instantiate the full set of XAI evaluation metrics from ExpliTest.
...
def load_tuned_artifact_or_none(dataset: str, model: str) -> Optional[str]:
    base = os.path.join("tuning", "saved_models", f"best_{dataset}_{model}")
...
def main():
    ...
    parser.add_argument("--saved-root", type=str, default="tuning/saved_models",
    ...
    parser.add_argument("--out-dir", type=str, default="xai_eval_results",
